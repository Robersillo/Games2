...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
        	...
        	<center><h2>Agrega Nuevas Noticias</h2></center>
			...
			<div class="contact_form">
              <form id="form2" name="form2" method="post" action="noticia_agregada.php">
                <table width="200" border="0" cellpadding="0" cellspacing="0">				
				
    <form action="noticia_agregada.php" method="POST" enctype="multipart/form-data">
				...
				<br>
                  ...
                  <tr>
                    <td>Noticia</td>
                    <td><textarea name="noticia" id="noticia" cols="45" rows="5"></textarea></td>
                  </tr>
                </table>
                <center>
                <!--<input name="Consulta" type="submit" class="register" id="Consulta" value="Enviar" />-->
                </center>
	</form>
                ...
                <INPUT type="radio" name="opcion_imagen" value="1">World of Warcraft<br />
<INPUT type="radio" name="opcion_imagen" value="2">League of Leguends<br />
   			  </div>
