    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
          ...
          <div class="content_box">
                ...
                <br>
                <br>
              <a href="http://es-es.twitch.tv/" target="_blank"><img class="image_wrapper image_fl" src="images/twitch6.png" alt="Image 1" /></a>
          <h5><a href="http://es-es.twitch.tv/" target="_blank">twitch.tv</a></h5>
                <p>Mejores LiveStreams Games</p>
            <p>Twitch es la plataforma y de la comunidad de video en vivo más grande para los jugadores, con más de 45 millones de visitantes al mes. Queremos conectar a los jugadores de todo el mundo, permitiéndoles emitir, ver y chatear desde cualquier plataforma en la que jueguen.</p>
              <p><a href="noticias.php">Lee Mas</a></p>
          </div>
            
             <div class="content_box">
            
            <center><h5>Mejores LiveStreams World of Warcraft</h5></center>
                <br>
...
$result = mysql_query("select * from swowandlol where tipo_img = 'wow' ");
...
{
echo '<img class="tablaimagenls" src="'.$row["img"].'" />';
}
...
?>
            ...
            <div class="content_box">
            <center><h5>Mejores LiveStreams League of Leguends</h5></center>
                <br>
...
$result = mysql_query("select * from swowandlol where tipo_img = 'lol' ");
